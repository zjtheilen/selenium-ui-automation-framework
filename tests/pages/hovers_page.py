...
class HoversPage(BasePage):
    ...
    def load(self):
        self.logger.info("Loading Hovers page")
        self.driver.get(self.URL)

    def hover_over_figure(self, index):
        self.logger.info("Hovering over figure")
